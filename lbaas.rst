...
.. csv-table::
   ...
   [controller_worker] amp_boot_network_list, "the id of amphora management network in ReionOne", "query neutron to obtain it, i.e., the id of lb-mgmt-net1 in this doc"
